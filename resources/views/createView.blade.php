        ...
        <form action="{{ url('/createDelivery') }}" class="needs-validation" novalidate method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                    <label class="form-label" for="">Type og Good<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="">delivery Provider<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="">Priority<span class="text-danger">*</span></label>
                ...
                <a href="{{ url("/viewAllDelivery") }}" class="btn btn-secondary">Back</a>
